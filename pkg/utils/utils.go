...
// HTTPClient is used to communicate with Vault and Data Catalog servers.
...
func GetEnvironmentVariables() (bool, string, string, string) {
	endpoint := os.Getenv("DATACATALOG_ENDPOINT")
	user := os.Getenv("DATACATALOG_USER")
	password := os.Getenv("DATACATALOG_PASSWORD")
