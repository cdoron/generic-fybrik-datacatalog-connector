...
type DefaultAPIController struct {
	// replace 'DefaultAPIServicer' with 'DataCatalogAPIServicer'
	service      DataCatalogAPIServicer
...
func NewDataCatalogAPIController(s DataCatalogAPIServicer, opts ...DefaultAPIOption) api.Router {
